...
\section{EXPERIENCE}
\textbf{Raytheon: Software Engineer I}
\hfill
\vspace{0.5em}
July 2023--Present
\begin{itemize}
\item{Hardware in the loop testing of missile systems in C++}
\end{itemize}
\vspace{1em}
...
\item{Implemented recovery software using a state machine architecture to transition between flight stages}
