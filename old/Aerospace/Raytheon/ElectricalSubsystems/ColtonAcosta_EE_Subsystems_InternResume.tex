...
August 2019-Present
\begin{itemize}
	\item{Leading efforts on the development of an integrated avionics system for a liquid rocket engine with over 20 electronic components including actuators, sensors, controllers, and signal processing circuitry}
