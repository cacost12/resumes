...
\maketitle
\section{SUMMARY}
Junior aerospace engineering student with collaborative project experience in hardware-software interfacing, specification development, and programming with interests in control theory and signal processing. Open to relocation. 
\section{EDUCATION}
...
\begin{itemize}
	...
	\item{Conducting trade studies on electronic actuators and orifice flow meters to develop propellant throttling specifications using MATLAB for multivariate trade-off analyses and physical modeling}
