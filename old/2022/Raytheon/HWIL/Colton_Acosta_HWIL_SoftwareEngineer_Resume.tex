...
\textbf{Garmin Aviation: Embedded Graphics Software Engineering Intern}
\hfill
\vspace{0.5em}
...
\item{Resolved runtime errors caused by randomized test vectors by analyzing the source code functions and manually setting up complex data structures and dereferenced pointers}
\end{itemize}
\vspace{1em}
...
\begin{itemize}
	...
	\item  Built the actuator control system using a brushed DC motor, Arduino controller, and a rotary encoder for feedback
\end{itemize}
\vspace{0.5em}
\thispagestyle{empty}
\thispagestyle{empty}
