...
\subsection{Modeling/Sims}
MATLAB/Simulink, LTspice, KiCAD, DipTrace,  Cadence 
\subsection{Software} 
C, C++, Python, Assembly, Linux, Git, Make, ARM Cortex-M, Visual Studio 
\subsection{Hardware}
...
\end{itemize}
\section{PROJECTS}
\textbf{Valve Actuator Flow Control System}\hfill Fall 2020
\vspace{0.5em}
\begin{itemize}
	...
	\item  Built the actuator using a brushed DC motor, coupling shaft, Arduino, and a quadrature rotary encoder for feedback
\end{itemize}
\vspace{0.5em}
