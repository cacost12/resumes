...
\item{ Maintained vehicle configs such as telemetry channels and rates and pushed code to the monorepository }
...
\item{Equipped the computer with an ARM Cortex-M7 microcontroller, a barometric pressure sensor, external flash, and a USB interface}
